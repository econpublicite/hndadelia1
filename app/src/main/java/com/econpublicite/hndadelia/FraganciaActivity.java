...
public class FraganciaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fragancia);
        ...
        miWebView.loadUrl("https://hinodeadelia.blogspot.com/search/label/Fragancias");
        ...
        miWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView webView,int errorCode,String description,String failingUrl) {
                ...
                AlertDialog dialogo = new AlertDialog.Builder(FraganciaActivity.this).create();
