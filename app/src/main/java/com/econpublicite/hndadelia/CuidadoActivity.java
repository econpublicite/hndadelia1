    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        miWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view,String url) {
                ...
                if (url.startsWith("https://api.whatsapp.com") || url.startsWith("https://api.whatsapp.com")) {
                    return false;
        ...
        miWebView.loadUrl("https://hinodeadelia.blogspot.com/search/label/Cuidado");
        ...
        miWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView webView,int errorCode,String description,String failingUrl) {
                ...
                AlertDialog dialogo = new AlertDialog.Builder(CuidadoActivity.this).create();
                dialogo.setTitle("Sin conexion");
                dialogo.setMessage("Por favor, verifica tu conexión a internet para ver nuestros Catalogo De Productos de Cuidaod");
